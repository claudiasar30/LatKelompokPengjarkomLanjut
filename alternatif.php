    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        foreach ($rows as $row) { ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-xs btn-warning" href="?m=alternatif_ubah&ID=<?php $row->kode_alternatif ?>"><span class="glyphicon glyphicon-edit"></span></a>
                    <a class="btn btn-xs btn-danger" href="aksi.php?act=alternatif_hapus&ID=<?php  $row->kode_alternatif ?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
        <?php } ?>
    </table>
